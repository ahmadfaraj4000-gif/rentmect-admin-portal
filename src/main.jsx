...
function Dashboard({ canViewFinancialSummary = false, snapshot, dashboard, vehicles, rentals = [], maintenanceSchedules = [], emergencyExceptions = [], sendManualReminder, depositTasks = [], depositAllocations = [], onStripeRefund, onExternalRefund, onEscalate, onOpenRental }) {
  ...
  return <>
    <section className="metric-grid">
      ...
      {canViewFinancialSummary && <Metric icon={Banknote} label="Month Revenue" value={money(snapshot?.month_revenue ?? dashboard.monthRevenue)} />}
      {canViewFinancialSummary && <Metric icon={CreditCard} label="Active Deposits" value={money(snapshot?.active_deposits ?? dashboard.deposits)} />}
    </section>
